...
describe('Number of return trips', function() {
    it("Checking number of returns possible in a trip to Pinelands during off-peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking number of returns possible in a trip to Pinelands during peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking number of returns possible in a trip to Milnerton during off-peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking number of returns possible in a trip to Milnerton during peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking number of returns possible in a trip to Atlantis during off-peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking number of returns possible in a trip to Atlantis during peak", function() {
        const bus_travel = bus_travel_factory()
...
describe('Cost of return trip', function() {
    it("Checking The cost of return trip to Pinelands during off peak", function() {
        const bus_travel = bus_travel_factory()
        ...
        assert.equal(60, bus_travel.price_per_return_trip())
    })

    it("Checking The cost of return trip to Pinelands during peak", function() {
        const bus_travel = bus_travel_factory()
        ...
        assert.equal(75, bus_travel.price_per_return_trip())
    })

    it("Checking The cost of return trip to Milnerton during off peak", function() {
        const bus_travel = bus_travel_factory()
        ...
        assert.equal(40, bus_travel.price_per_return_trip())
    })

    it("Checking The cost of return trip to Milnerton during peak", function() {
        const bus_travel = bus_travel_factory()
        ...
        assert.equal(50, bus_travel.price_per_return_trip())
    })

    it("Checking The cost of return trip to Atlantis during off peak", function() {
        const bus_travel = bus_travel_factory()
    ...
    it("Checking The cost of return trip to Atlantis during peak", function() {
        const bus_travel = bus_travel_factory()
